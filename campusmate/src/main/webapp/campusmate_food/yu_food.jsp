	...
	<div class="notice-box">
		...
		<div class="gallery-table">
			<ul class="table-bd">
				<li>
					<div class="thum">
						<a href="./gallery_view.html"><img src="../img/yu/yu_food_1.jpg" alt=""></a>
					</div>
					<div class="info">
				...
				<li>
					<div class="thum">
						<a href="./gallery_view.html"><img src="../img/yu/yu_food_2.jpg" alt=""></a>
					</div>
					<div class="info">
						<h3><a href="./gallery_view.html">게시물 제목</a></h3>
						<p>게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시</p>
				...
				<li>
					<div class="thum">
						<a href="./gallery_view.html"><img src="../img/yu/yu_food_3.jpg" alt=""></a>
					</div>
					<div class="info">
						<h3><a href="./gallery_view.html">게시물 제목</a></h3>
						<p>게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시</p>
				...
				<li>
					<div class="thum">
						<a href="./gallery_view.html"><img src="../img/yu/yu_food_4.jpg" alt=""></a>
					</div>
					<div class="info">
						<h3><a href="./gallery_view.html">게시물 제목</a></h3>
						<p>게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시</p>
				...
				<li>
					<div class="thum">
						<a href="./gallery_view.html"><img src="../img/yu/yu_food_5.jpg" alt=""></a>
					</div>
					<div class="info">
						<h3><a href="./gallery_view.html">게시물 제목</a></h3>
						<p>게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시물 내용게시</p>
